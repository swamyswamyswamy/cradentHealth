...
import 'package:cradenthealth/view/screens/bookings/booking_history_diagnostics_details.dart';
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      return Padding(
                        ...
                        child: InkWell(
                          onTap: () {
                            final booking = _diagnosticsController
                                .bookingsHistoryDiagnosticResponseModel
                                .value
                                .bookings![index];
                            Get.to(() => DiagnosticBookingDetailsScreen(
                                booking: booking));
                          },
                          child: Container(
