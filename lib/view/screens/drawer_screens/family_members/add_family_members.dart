        ...
        child: Column(
          children: [
            ...
            Inputfield(
              ...
              controller:
                  TextEditingController(text: _familyController.fullName.value),
              label: "Name",
            ...
            Inputfield(
              fillColor: AppColors.secondaryColor,
              controller:
                  TextEditingController(text: _familyController.relation.value),
              label: "Relation",
              keyboardType: TextInputType.text,
              hinttext: "",
              onChanged: (value) {
            ...
            Inputfield(
              fillColor: AppColors.secondaryColor,
              controller:
                  TextEditingController(text: _familyController.eyeSight.value),
              label: "Eye Sight",
              keyboardType: TextInputType.text,
              hinttext: "",
              onChanged: (value) {
              ...
              children: [
                Expanded(
                  child: Inputfield(
                    fillColor: AppColors.secondaryColor,
                    controller:
                        TextEditingController(text: _familyController.BP.value),
                    label: "BP",
                    keyboardType: TextInputType.text,
                    hinttext: "",
                    onChanged: (value) {
